# VAELORIA — Ability Rank Progressions, Levels 1–20 (all nine classes)
...
| | **2** | **16** | 50 | 1.5 | root 12s **+ dot 32/12s** (4×8; vanilla-style damaging roots — two effects, no new types) |
