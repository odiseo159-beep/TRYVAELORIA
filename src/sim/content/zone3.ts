...
const HIGHWATCH_CAMPFIRE = { x: 2, z: 658 };
...
export const ZONE3_NPCS: Record<string, NpcDef> = {
  captain_thessaly: {
    ...
    pos: { x: 4, z: 664 }, facing: facePoint({ x: 4, z: 664 }, HIGHWATCH_CAMPFIRE), color: 0x85929e,
  ...
  brother_aldric_highwatch: {
    ...
    pos: { x: -10, z: 656 }, facing: facePoint({ x: -10, z: 656 }, HIGHWATCH_CAMPFIRE), color: 0xf7f9f9,
    questIds: [
  ...
  scout_maren_highwatch: {
    ...
    pos: { x: 7, z: 670 }, facing: facePoint({ x: 7, z: 670 }, HIGHWATCH_CAMPFIRE), color: 0x6e8b3d,
  ...
  quartermaster_bree: {
    ...
    pos: { x: -5, z: 668 }, facing: facePoint({ x: -5, z: 668 }, HIGHWATCH_CAMPFIRE), color: 0xca8a2a,
  ...
  armorer_hode: {
    ...
    pos: { x: -2, z: 672 }, facing: facePoint({ x: -2, z: 672 }, HIGHWATCH_CAMPFIRE), color: 0x717d7e,
    questIds: [],
  ...
  loremaster_caddis: {
    ...
    pos: { x: 12, z: 655 }, facing: facePoint({ x: 12, z: 655 }, HIGHWATCH_CAMPFIRE), color: 0x3b6ea5,
